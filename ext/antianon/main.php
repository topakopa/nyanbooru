...
/** @extends Extension<AntianonTheme> */
final class Antianon extends Extension
{
    ...
    {
        if (Ctx::$config->get(AntianonConfig::ANTIANON)) {
            if (!Ctx::$user->can(AntianonPermission::IGNORE_ANTIANON) && !$this->is_safe_page($event)) {
